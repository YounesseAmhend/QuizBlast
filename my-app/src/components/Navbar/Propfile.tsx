...
export default function Profile(props: Props){
    ...
    return (
        <div ref={popupRef}>
            {(visiblePopUp && loaded) &&  
                <div  className= " border-1 bg-white fixed rounded p-4 right-0 py-2 mt-8 mr-24 max-[600px]:mr-20">
            ...
            <div className="cursor-pointer flex items-center justify-center w-12 h-12 mr-2 ">
